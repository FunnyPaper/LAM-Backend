...
import { ApiBearerAuth, ApiExtraModels, ApiNoContentResponse, ApiOkResponse, getSchemaPath } from '@nestjs/swagger';
...
@Controller('users/me/envs')
export class EnvSelfController {
